...
(function(mod) {
  ...
  // For some reason, the global Date object is not available in our deployments on Heroku, so we manually set it from the window here to hack around the bug "for now"
  // TODO Figure out what's causing this and fix it
